...
list_of_names = ['Camel', 'Lion', 'Deer', 'Goose', 'Bat', 'Rabbit']


user_input = input(f"There are fallowing habitats in the zoo:\n"
                   f"{list_of_names}.\n"
                   f"Please choose with entering numbers from 0 to 5:\n"
                   f"===>>> ")
